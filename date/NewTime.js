...
strFrame='<style>';
strFrame+='INPUT.button{BORDER-RIGHT: #dda391 1px solid;BORDER-TOP: #dda391 1px solid;BORDER-LEFT: #dda391 1px solid;';
strFrame+='BORDER-BOTTOM: #dda391 1px solid;BACKGROUND-COLOR: #dda391;font-family:宋体;}';
...
strFrame+='<span id=tmpSelectHourLayer  style="z-index: 9999;position: absolute;top: 188; left: 73px;display: none"></span>';
strFrame+='<span id=tmpSelectMinuteLayer style="z-index:9999;position:absolute;top: 188; left: 116px;display: none"></span>';
strFrame+='<table border=1 cellspacing=0 cellpadding=0 width=142 height=160 bordercolor=#dda391 bgcolor=#dda391 >';
...
strFrame+='                <td width=16 align=center bgcolor=#dda391 style="font-size:12px;cursor: hand;color: #ffffff" ';
strFrame+='        onclick="parent.meizzPrevM()" title="向前翻 1 月" ><b >&lt;</b></td>';
strFrame+='       <td width=60 align="center" bgcolor="#dda391"  style="font-size:12px;cursor:hand" ';
strFrame+='           onmouseover="style.backgroundColor=\'#aaccf3\'"';
strFrame+='        onmouseout="style.backgroundColor=\'#dda391\'" ';
...
strFrame+='        bgcolor="#dda391" onmouseover="style.backgroundColor=\'#aaccf3\'" ';
strFrame+='        onmouseout="style.backgroundColor=\'#dda391\'" ';
...
strFrame+='       <td width=16 bgcolor=#dda391 align=center style="font-size:12px;cursor: hand;color: #ffffff" ';
strFrame+='        onclick="parent.meizzNextM()" title="向后翻 1 月" ><b >&gt;</b></td>';
strFrame+='      </tr>';
strFrame+='     </table></td></tr>';
strFrame+='    <tr><td width=142 height=18 >';
strFrame+='     <table border=0 cellspacing=0 cellpadding=2 bgcolor=#dda391 ' + (bMoveable? 'onmousedown="DragStart()" onmouseup="DragEnd()"':'');
strFrame+='    BORDERCOLORLIGHT=#dda391 BORDERCOLORDARK=#FFFFFF width=140 height=20  style="cursor:' + (bMoveable ? 'move':'default') + '">';
...
strFrame+='    <table border=1 cellspacing=2 cellpadding=2 BORDERCOLORLIGHT=#dda391 BORDERCOLORDARK=#FFFFFF bgcolor=#fff8ec width=140 height=120 >';
...
strFrame+='          <tr bgcolor="#dda391"><td id=bUseTimeLayer width=50  style="cursor:hand" title="日历选择控件"';
strFrame+='    onmouseover="style.backgroundColor=\'#aaccf3\'" align=center onmouseout="style.backgroundColor=\'#dda391\'"';
strFrame+='     >';
...
strFrame+=' onmouseover="style.backgroundColor=\'#aaccf3\'" onmouseout="style.backgroundColor=\'#dda391\'"';
strFrame+=' title="点击这里选择时间" align=center width=30>' ;
...
function meizzSetDay(yy,mm) //主要的写程序**********
{
 ...
 {
  //初始化边框
  da.borderColorLight="#dda391";
  da.borderColorDark="#dda391";
